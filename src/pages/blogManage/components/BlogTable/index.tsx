...
import { getBlogsList } from "@/axios/model/blog";
...
const columns: ColumnsType<BlogData> = [
  ...
  },
  {
    ...
    key: 'groupIsShow',
    width: 100,
    render: (_, { groupId, groupIsShow }) => <Switch checked={groupIsShow} onChange={() => groupShow(groupId, groupIsShow)} />,
    align: "center"
  },
  {
    title: '文章标题',
  ...
  },
  {
    ...
    width: 80,
    align: "center",
    render: (_, { id, isShow }) => <Switch checked={isShow} onChange={() => blogShow(id, isShow)} />
  },
  {
    title: '文章内容',
    dataIndex: 'content',
...
const BlogTable = forwardRef<any>((props, ref) => {
  ...
  const getTableList = async () => {
    const list = await getBlogsList({ current: pagination.current!, pageSize: pagination.pageSize! })
